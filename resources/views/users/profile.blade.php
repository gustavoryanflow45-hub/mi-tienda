...
<div style="background:#f2f3f8; padding:30px 0 60px; min-height:70vh;">
    <div class="container" style="max-width:640px;">
        ...
        <h2 style="font-size:1.15rem; font-weight:700; color:#222; margin-bottom:20px;">
            <i class="las la-user-circle" style="color:#679941;"></i> {{ __('Mi perfil') }}
        </h2>
        ...
        <div style="background:#fff; border-radius:10px; box-shadow:0 2px 10px rgba(0,0,0,.07); padding:28px;">
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <div style="margin-bottom:16px;">
                    <label style="font-size:.82rem; font-weight:600; color:#555; display:block; margin-bottom:5px;">{{ __('Nombre completo') }}</label>
                ...
                <div style="margin-bottom:16px;">
                    <label style="font-size:.82rem; font-weight:600; color:#555; display:block; margin-bottom:5px;">{{ __('Teléfono') }}</label>
                    <input type="text" name="phone" value="{{ old('phone', auth()->user()->phone) }}"
                        style="width:100%; border:1px solid #dde2e8; border-radius:6px; padding:10px 14px; font-size:.88rem; outline:none; box-sizing:border-box;">
                </div>

                <hr style="border:none; border-top:1px solid #f0f0f0; margin:20px 0;">
                <p style="font-size:.82rem; color:#888; margin-bottom:16px;">{{ __('Dejar en blanco para mantener la contraseña actual.') }}</p>
                ...
                <div style="margin-bottom:24px;">
                    <label style="font-size:.82rem; font-weight:600; color:#555; display:block; margin-bottom:5px;">{{ __('Confirmar nueva contraseña') }}</label>
